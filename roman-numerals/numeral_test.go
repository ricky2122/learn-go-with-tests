...
func TestRomanNumerals(t *testing.T) {
	cases := []struct {
		...
		{Description: "5 gets converted to VI", Arabic: 6, Want: "VI"},
		{Description: "5 gets converted to VII", Arabic: 7, Want: "VII"},
		{Description: "5 gets converted to VIII", Arabic: 8, Want: "VIII"},
	}
